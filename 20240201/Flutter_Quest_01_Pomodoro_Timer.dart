...
//회고
// 자바를 배워서 쉽게 이해할 것 같았지만 오히려 공부를 하면서 헷갈리는 부분이 많았습니다.
// 프로젝트를하면서 다트 프로그래밍에 대해 이해가 좀 더 많이 됫습니다.
// 앞으로 많은 프로젝트나 실습으로 빨리 다트프로그래밍에 대해 이해력을 높여야 겠습니다.
