...
-우진-
이번 퀘스트를 통해 플러터에 기본 위젯 사용방법을 이해하게 되었습니다. 특히 container의 위젯의 속성을 조절하여 배경색,마진,크기등을
설정하는 방법과 Stack위젯을 통해 겹쳐진 레이아웃을 만드는 방법에 대해 알게되었습니다.
그리고 SizedBox를 사용해 각 요소 사이에 고정된 크기의 공간을 만들어 외관상 레이아웃을 깔끔하게 만드는 방법에 대해서도 배웠습니다.
이제 아이펠톤이 얼마 안남은 상황에서 진도는 끊임없이 나가는데 아직 이해가 부족해서 걱정이 앞섭니다.
앞으로 다양한 위젯들을 더 활용해서 레이아웃 구성능력과 플러터에 대한 전반적인 이해를 기르기 위해 더 노력해야 겠습니다.
